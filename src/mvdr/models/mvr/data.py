...
class TrainDataset(Dataset):
    ...
    def create_one_example(self, text_encoding: List[int], is_query=False):
        ...
        for key in item.keys():
            item[key] = item[key][1:] # drop [CLS] token
    ...
    def __getitem__(self, item) -> Tuple[BatchEncoding, List[BatchEncoding]]:
        ...
        # print(self.tok.decode(encoded_query["input_ids"]))
        # print(self.tok.decode(encoded_passages[0]["input_ids"]))
...
class EncodeDataset(Dataset):
    ...
    def __getitem__(self, item) -> Tuple[str, BatchEncoding]:
        ...
        for key in encoded_text.keys():
            encoded_text[key] = encoded_text[key][1:] # drop [CLS] token
        
        # print(encoded_text["input_ids"])
        # print(self.tok.decode(encoded_text["input_ids"]))
        # import pdb; pdb.set_trace();
