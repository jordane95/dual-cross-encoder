...
from .modeling import DenseOutput, DenseModelForInference
from .dataset import HFQueryDataset, HFCorpusDataset
        ...
        with torch.cuda.amp.autocast() if training_args.fp16 else nullcontext():
            with torch.no_grad():
                ...
                if data_args.encode_is_qry:
                    ...
                    multi_vec_ids = [text_id for text_id in batch_ids for _ in range(data_args.num_query)]
                    lookup_indices.extend(multi_vec_ids)
