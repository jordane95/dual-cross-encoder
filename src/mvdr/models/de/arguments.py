...
@dataclass
class DataArguments:
    all_concat: bool = field(
        default=False, metadata={"help": "During document encoding, whether prepending all queries or individuallly."}
    )
    num_query: int = field(
        default=10, metadata={"help": "Number of queries to be prefixed to document for encoding."}
    )
